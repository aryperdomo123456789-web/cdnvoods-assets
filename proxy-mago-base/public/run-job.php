...
try {
    $fn = match ($job) {
        ...
        'metrics_rollup' => fn (array &$s) => RestreamRuntime::metricsRollupLight($s),
        'metrics_rollup_light' => fn (array &$s) => RestreamRuntime::metricsRollupLight($s),
        'metrics_rollup_analytics' => fn (array &$s) => RestreamRuntime::metricsRollupAnalytics($s),
